...
class _BotCommands:
    def __init__(self):
        ...
        self.QbMirrorCommand = f'bit{CMD_INDEX}'
        self.QbUnzipMirrorCommand = f'bitunzip{CMD_INDEX}'
        self.QbZipMirrorCommand = f'bitzip{CMD_INDEX}'
        ...
        self.QbLeechCommand = f'bitleech{CMD_INDEX}'
        self.QbUnzipLeechCommand = f'bitunzipleech{CMD_INDEX}'
        self.QbZipLeechCommand = f'bitzipleech{CMD_INDEX}'
